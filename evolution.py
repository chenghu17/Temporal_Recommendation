...
def Precision(validationPath, timestamp, userMat, itemMat, K):
    ...
    precisionRate = 0
    # test
    user_right_item = open('user_right_item_' + str(K) + '.txt', 'a')
    for userId in userSet:
        ...
        user_right_item.write(str(userId) + ":" + str(TP) + '\n')
...
if __name__ == '__main__':
    ...
    resultPath = 'alpha_0.02_alphaReg_0.1_gama_0.02/'
    ...
    itemMat_6 = np.loadtxt(rootPath + 'evolution6-s/itemMat0.txt')
    userMat_6 = np.loadtxt(rootPath + 'evolution6-s/userMat0.txt')
    ...
    #
    # itemMat_stand = np.loadtxt(rootPath + 'evolution_standard/itemMat0.txt')
    # userMat_stand = np.loadtxt(rootPath + 'evolution_standard/userMat0.txt')
    ...
    # MRR_6 = MRR(validationPath, timestamp_3, userMat_6, itemMat_6, k)
    # print('MRR_6:',MRR_6)
